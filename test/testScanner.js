...
exports['Instance'] = function(assert){
	utils.getHBase(function(error, hbase){
		assert.ok(hbase.getScanner('node_table') instanceof Scanner);
		assert.ok(hbase.getScanner('node_table', 'my_id') instanceof Scanner);
		assert.ok(hbase.getTable('node_table').getScanner() instanceof Scanner);
		assert.ok(hbase.getTable('node_table').getScanner('my_id') instanceof Scanner);
	});
};
